...
//import axios from '../../../../axios';
class IndexAugmentation extends Component{
    constructor(props) {
        super(props);
        this.state = {
          isShow: true,
        ...
        <div> 
            <Router basename={'/whims'}>                                                   
                <Switch>
                    ...
                    <Route exact path="/request/release/" render={props => <Stockpile {...props} requests={this.props.requests}/>}/>
...
export default IndexAugmentation;